...
if __name__=="__main__":
    ...
    description_data = json_load(os.path.join(prefix_data_dir, description_file))
    script_data = json_load(os.path.join(prefix_data_dir, script_file))

    for data_name in data_name_list:
        cur_data = json_load(os.path.join(prefix_data_dir,data_name))
        inform = []
